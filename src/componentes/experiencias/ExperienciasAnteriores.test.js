...
import ExperienciasAnteriores, {NODE_JS, SQL, CSHARP, HTML} from './ExperienciasAnteriores';
...
describe('ExperienciasAnteriores', () => {
    test('ExperienciasAnteriores deve renderizar titulo', () => {
        ...
        const experienciasAnterioresTitulo = screen.getByText('Experiências Anteriores');
